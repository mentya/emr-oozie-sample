...
then
	...
	sudo -u hadoop cp /home/hadoop/share/hadoop/common/lib/s3-dist-cp-1.3.0.jar /opt/oozie-4.0.1/libext/
	sudo -u hadoop cp /usr/share/aws/emr/emrfs/lib/*.jar /opt/oozie-4.0.1/libext/
